...
function NotificationsList({ notifications, onFetch, hasNextPage, onNotificationClicked, }) {
    ...
    return (react_1.default.createElement(ListWrapper, { className: (0, css_1.cx)('nc-notifications-list', (0, css_1.css)(notificationsListStyles)), "data-test-id": "notifications-scroll-area" },
        react_1.default.createElement(react_infinite_scroll_component_1.default, { dataLength: totalCount, next: onFetch, hasMore: hasNextPage, height: 400, loader: react_1.default.createElement(Loader_1.Loader, null), endMessage: false }, notifications.map((notification) => {
