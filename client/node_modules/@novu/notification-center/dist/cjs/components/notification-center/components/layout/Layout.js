...
function Layout() {
    ...
    return (react_1.default.createElement("div", { className: (0, css_1.cx)('nc-layout-wrapper', layoutWrapperCss(theme), (0, css_1.css)(layoutStyles)), "data-test-id": "layout-wrapper" },
        screen === interfaces_1.ScreensEnum.SETTINGS && (react_1.default.createElement(react_1.default.Fragment, null,
            header ? (header({ setScreen })) : (react_1.default.createElement(UserPreferenceHeader_1.UserPreferenceHeader, { onBackClick: () => setScreen(interfaces_1.ScreensEnum.NOTIFICATIONS) })),
            react_1.default.createElement(ContentWrapper, null,
                react_1.default.createElement(SubscriberPreference_1.SubscriberPreference, null)))),
        screen === interfaces_1.ScreensEnum.NOTIFICATIONS && (react_1.default.createElement(react_1.default.Fragment, null,
            header ? header({ setScreen }) : react_1.default.createElement(Header_1.Header, { onCogClick: () => setScreen(interfaces_1.ScreensEnum.SETTINGS) }),
