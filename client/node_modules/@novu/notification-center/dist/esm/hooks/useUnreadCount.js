...
export const useUnreadCount = (_a = {}) => {
    ...
    const result = useQuery(unreadCountQueryKey, () => apiService.getUnreadCount({ limit: 100 }), Object.assign(Object.assign({}, restOptions), { enabled: isSessionInitialized && fetchingStrategy.fetchUnseenCount, onSuccess: (data) => {
